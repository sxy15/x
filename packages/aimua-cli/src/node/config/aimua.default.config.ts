import { defineConfig } from './aimua.config.js'
...
const description = {
  'zh-CN':
    'Aimua 是一个基于 Vue3 开发的 Material 风格移动端组件库，全面拥抱 Vue3 生态，由社区团队维护。支持 Typescript、按需引入、暗黑模式、主题定制、国际化，并提供 VSCode 插件保障良好的开发体验。',
  'en-US':
    'Aimua is a Material design mobile component library developed based on Vue3, developed and maintained by partners in the community. Support Typescript, import on demand, dark mode, theme customization, internationalization, and provide VSCode plugin to ensure a good development experience.',
}

const keywords = {
  'zh-CN': 'Aimua,Vue3 移动端组件库,Material Design',
  'en-US': 'Aimua,Vue3 Mobile Components Library,Material Design',
}
...
export default defineConfig({
  ...
  pc: {
    ...
    indexPage: {
      ...
      copyright: {
        'zh-CN': 'Copyright © 2022 Aimua 组织成员以及 Aimua 的贡献者们',
        'en-US': 'Copyright © 2022 Aimua member and Aimua contributors.',
      },
    },
    header: {
      i18n: {
      ...
      versions: null,
      github: 'https://github.com/sxy15/aimua',
      playground: '',
      darkMode: true,
    },
    clipboard: {
  ...
  icons: {
    name: 'aimua-icons',
    namespace: 'aimua-icon',
    fontStyle: 'normal',
    fontWeight: 'normal',
    fontFamilyClassName: 'aimua-icon--set',
    base64: true,
  },
  esbuild: {
    target: 'es2016',
